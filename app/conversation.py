...
class ConversationManager:
    ...
    def get_transcript_payload(
        ...
        # ★ 注入提示词绕过 Notion AI 限制
        from app.prompt_injection import inject_prompt_into_transcript, clean_refusal_from_history
        transcript = clean_refusal_from_history(transcript)
        transcript = inject_prompt_into_transcript(transcript, enable_few_shot=True)
...
def build_lite_transcript(user_prompt: str, model_name: str) -> list[dict[str, Any]]:
    ...
    from app.prompt_injection import inject_prompt_into_transcript
    import uuid
